...
export async function addBlockAction(collectionId: string, data: unknown): Promise<ActionResult> {
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : '블록 추가에 실패했습니다',
    }
  }
}
...
export async function updateBlockAction(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : '블록 수정에 실패했습니다',
    }
  }
}
...
export async function deleteBlockAction(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : '블록 삭제에 실패했습니다',
    }
  }
}
...
export async function togglePublicAction(collectionId: string): Promise<ActionResult> {
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : '공유 설정에 실패했습니다',
    }
  }
}

export async function updateSlugAction(collectionId: string, slug: string): Promise<ActionResult> {
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : '슬러그 변경에 실패했습니다',
    }
  }
}
